<div class="space-y-6 animate-fadeIn pb-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Gérez les lieux de culte et leurs horaires.</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    @empty
                    <tr><td colspan="4" class="py-8 text-center text-gray-500">Aucune paroisse trouvée.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 flex items-center gap-2 mt-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg> {{ $currentParish->contact_phone }}</p>
                                </div>
                                <div class="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-xl">
                                    <h4 class="font-bold text-gray-900 dark:text-white mb-2">Horaires des Messes</h4>
                                    <div class="prose dark:prose-invert text-sm">{!! $currentParish->mass_schedules !!}</div>
                                </div>
                            </div>
                            ...
                            @if($currentParish->history)
                                <div class="border-t border-gray-100 dark:border-gray-700 pt-4">
                                    ...
                                    <div class="prose dark:prose-invert">{!! $currentParish->history !!}</div>
                                </div>
                            @endif
                        </div>
