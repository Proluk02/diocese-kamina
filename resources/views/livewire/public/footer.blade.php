    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div class="col-span-1 md:col-span-1 space-y-6">
                <a href="/" class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[10px] text-gray-400 font-bold tracking-[0.25em] uppercase">de Kamina</span>
                    </div>
                </a>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="{{ route('home') }}" class="hover:text-kamina-gold transition">Accueil</a></li>
                    <li><a href="{{ route('news.index') }}" class="hover:text-kamina-gold transition">Actualités</a></li>
                    <li><a href="{{ route('parishes.public.index') }}" class="hover:text-kamina-gold transition">Paroisses</a></li>
                    <li><a href="{{ route('liturgy.public.index') }}" class="hover:text-kamina-gold transition">Liturgie</a></li>
                    <li><a href="{{ route('donation') }}" class="hover:text-kamina-gold transition">Faire un don</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="{{ route('documents.public.index') }}" class="hover:text-kamina-gold transition">Documents Officiels</a></li>
                    <li><a href="{{ route('presentation') }}" class="hover:text-kamina-gold transition">Qui sommes-nous ?</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-kamina-gold transition">Contact</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-gray-400">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:contact@diocesekamina.org" class="hover:text-white transition">contact@diocesekamina.org</a>
                    </li>
                    <li class="flex items-center gap-3">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
            ...
            <div class="mt-4 md:mt-0 space-x-6">
                ...
                <a href="#" class="hover:text-white transition">Plan du site</a>
            </div>
        </div>
    </div>
</footer>